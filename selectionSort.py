...
#                 if proximo.pessoa.idade < menor.pessoa.idade:
#                     menor = proximo
#                 proximo = proximo.proximo
#             # Troca os dados (sem mexer nos ponteiros)
#             atual.pessoa, menor.pessoa = menor.pessoa, atual.pessoa
#             atual = atual.proximo
#
#
...
#     print(list)
#
# selection_sort([3,12,2,14,4,5,6,67,60])
